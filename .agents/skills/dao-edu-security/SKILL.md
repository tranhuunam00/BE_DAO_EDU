---
name: dao-edu-security
description: Audit and harden security in the DAO EDU backend and related web application. Use when reviewing authentication, authorization, secrets, environment variables, database access, input validation, dependencies, rate limiting, CORS, file uploads, webhooks, sessions, or OWASP and CWE risks.
---

# DAO EDU Security Audit
