...
import { CalculateTeacherWageUseCase } from './application/use-cases/calculate-teacher-wage.use-case';
...
@Module({
  ...
  exports: [GetStudentTuitionReportUseCase, CalculateStudentTuitionUseCase, CalculateTeacherWageUseCase],
})
